...
result_df = pd.read_csv(r'C:\Users\user\Desktop\datas\result_df.csv')
result_df_p = pd.read_csv(r'C:\Users\user\Desktop\datas\result_df_p.csv')
df_swing_table_all = pd.read_csv(r'C:\Users\user\Desktop\datas\df_swing_table_all.csv')
